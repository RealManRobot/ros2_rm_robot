...
| Return value | Trajectorylist.msg<br>int32 page_num # Page number<br>int32 page_size # Size per page<br>int32 total_size # Length of the list <br> string vague_search # Fuzzy search<br>Trajectoryinfo[] tra_list # List of trajectories that match the criteria<br>bool state # Query status - true for success, false for failure<br> The definition of Trajectoryinfo.msg is as follows:<br>string name          # Trajectory name  <br> string create_time   # Creation time  <br>int32 point_num      # Number of trajectory points  |
...
| Command example | ros2 topic pub --once /rm_driver/set_rm_plus_mode_cmd std_msgs/msg/UInt32 "data: 115200" |
| Return value | Successful return: true; failure returns: false, the driver terminal returns an error code. |
...
| Command example | ros2 topic pub --once /rm_driver/set_rm_plus_touch_cmd std_msgs/msg/UInt32 "data: 0" |
| Return value | Successful return: true; failure returns: false, the driver terminal returns an error code. |
...
| Function description | Robotic arm error code |
| :---: | :---- |
| Parameter description | uint8 err_len  : number of error code<br>int32[] err  : error code list  |
