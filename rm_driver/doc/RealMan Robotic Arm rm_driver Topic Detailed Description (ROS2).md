...
| :---: | :---- |
| Parameter description | Movej.msg<br>float32[6] joint：joint angle, unit: radians.<br>uint8 speed：speed percentage ratio coefficient, 0~100.<br>uint8 trajectory_connect:0 represents immediate planning, 1 represents planning together with the next trajectory, and when it is 1, the trajectory will not be executed immediately.<br>bool block：whether it is a blocking mode，bool type，true:blocking，false:non-blocking. |
