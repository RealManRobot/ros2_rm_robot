...
| 功能描述 | 关节空间运动MOVEJ |
| :---: | :---- |
| 参数说明 | Movej.msg<br>float32[] joint：关节角度，单位：弧度。<br>uint8 speed：速度百分比例系数，0~100。<br>uint8 trajectory_connect:0 代表立即规划，1 代表和下一条轨迹一起规划，当为 1 时，轨迹不会立即执行<br>bool block：是否为阻塞模式，bool类型，true:阻塞，false:非阻塞。 |
