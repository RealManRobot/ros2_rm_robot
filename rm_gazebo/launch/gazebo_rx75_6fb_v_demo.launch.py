...
def generate_launch_description():
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "or the shim package 'ros-humble-ign-ros2-control' before launching RX75 Gazebo."
        ) from exc

    pkg_share = get_package_share_directory(package_name)
    description_share = get_package_share_directory("rm_description")
    ros_gz_sim_share = get_package_share_directory("ros_gz_sim")
    urdf_model_path = os.path.join(pkg_share, "config", "gazebo_rx75_6fb_v_description.urdf.xacro")
